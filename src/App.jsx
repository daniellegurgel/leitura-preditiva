...
const frases = [
  ...
  { id: 11, inicio: "Mesmo sem sinais técnicos claros, ele entrou porque...", opcoes: [ { texto: "viu uma notícia positiva", vies: "Viés de Confirmação" }, { texto: "não queria perder a oportunidade", vies: "FOMO" }, { texto: "estava se sentindo sortudo", vies: "Otimismo Ilusório" }, { texto: "tinha dado certo da última vez", vies: "Viés de Retrospectiva" } ] },
  { id: 12, inicio: "Ele hesitou em vender porque...", opcoes: [ { texto: "achava que ainda podia subir", vies: "Otimismo Ilusório" }, { texto: "não queria realizar prejuízo", vies: "Aversão à Perda" }, { texto: "lembrou da última vez que vendeu cedo demais", vies: "Viés de Retrospectiva" }, { texto: "viu outros comprando", vies: "FOMO" } ] },
  { id: 13, inicio: "Ele pulou uma entrada boa porque...", opcoes: [ { texto: "tinha errado numa parecida ontem", vies: "Viés de Recência" }, { texto: "não queria se frustrar de novo", vies: "Aversão à Perda" }, { texto: "estava pessimista demais", vies: "Viés de Confirmação" }, { texto: "achou que ia cair", vies: "Excesso de Confiança" } ] },
  ...
  { id: 15, inicio: "Mesmo após bater a meta, ele continuou porque...", opcoes: [ { texto: "estava se sentindo invencível", vies: "Excesso de Confiança" }, { texto: "achava que ia conseguir dobrar", vies: "Otimismo Ilusório" }, { texto: "viu o grupo comentando sobre mais oportunidades", vies: "FOMO" }, { texto: "não queria perder o embalo", vies: "Viés de Recência" } ] },
  { id: 16, inicio: "Ele ficou inseguro de encerrar o trade porque...", opcoes: [ { texto: "esperava uma confirmação visual", vies: "Viés de Confirmação" }, { texto: "achava que ainda tinha mais espaço", vies: "Otimismo Ilusório" }, { texto: "não queria parecer precipitado", vies: "FOMO" }, { texto: "da última vez foi o fundo", vies: "Viés de Retrospectiva" } ] },
  { id: 17, inicio: "Ele decidiu aumentar a exposição no ativo porque...", opcoes: [ { texto: "estava indo bem", vies: "Viés de Recência" }, { texto: "lembrou do mês passado", vies: "Viés de Retrospectiva" }, { texto: "estava muito confiante", vies: "Excesso de Confiança" }, { texto: "não queria ficar de fora da movimentação", vies: "FOMO" } ] },
  { id: 18, inicio: "Ele deixou o lucro diminuir bastante porque...", opcoes: [ { texto: "achava que ia subir mais", vies: "Otimismo Ilusório" }, { texto: "não queria sair errado", vies: "Aversão à Perda" }, { texto: "esperava um sinal claro", vies: "Viés de Confirmação" }, { texto: "viu acontecer igual antes", vies: "Viés de Retrospectiva" } ] },
  { id: 19, inicio: "Mesmo após 3 stops seguidos, ele entrou novamente porque...", opcoes: [ { texto: "estava se sentindo pressionado", vies: "FOMO" }, { texto: "acreditava que agora ia dar certo", vies: "Viés de Confirmação" }, { texto: "o padrão gráfico parecia familiar", vies: "Viés de Retrospectiva" }, { texto: "não queria encerrar no prejuízo", vies: "Aversão à Perda" } ] },
  { id: 20, inicio: "Ele mudou a estratégia no meio do pregão porque...", opcoes: [ { texto: "viu outros resultados no grupo", vies: "FOMO" }, { texto: "perdeu confiança na anterior", vies: "Aversão à Perda" }, { texto: "acreditava em outra leitura", vies: "Viés de Confirmação" }, { texto: "queria recuperar rápido", vies: "Viés de Recência" } ] },
  { id: 21, inicio: "Ele ignorou o gerenciamento de risco porque...", opcoes: [ { texto: "tinha muita convicção", vies: "Excesso de Confiança" }, { texto: "achava que era a melhor chance do dia", vies: "Otimismo Ilusório" }, { texto: "viu outros fazendo o mesmo", vies: "FOMO" }, { texto: "ontem deu certo", vies: "Viés de Retrospectiva" } ] },
  { id: 22, inicio: "Ele não fez a entrada planejada porque...", opcoes: [ { texto: "lembrou da última vez que falhou", vies: "Viés de Retrospectiva" }, { texto: "ficou inseguro na hora", vies: "Aversão à Perda" }, { texto: "o candle não ficou perfeito", vies: "Viés de Confirmação" }, { texto: "teve medo de entrar errado", vies: "FOMO" } ] },
  { id: 23, inicio: "Ele fechou a operação no 0x0 porque...", opcoes: [ { texto: "não queria perder", vies: "Aversão à Perda" }, { texto: "achava que o mercado ia virar", vies: "Viés de Confirmação" }, { texto: "ouviu alerta no grupo", vies: "FOMO" }, { texto: "já passou por isso antes", vies: "Viés de Retrospectiva" } ] },
  { id: 24, inicio: "Ele abriu várias operações ao mesmo tempo porque...", opcoes: [ { texto: "não queria ficar de fora de nenhuma", vies: "FOMO" }, { texto: "achava que todas iam andar", vies: "Otimismo Ilusório" }, { texto: "queria recuperar o tempo perdido", vies: "Viés de Recência" }, { texto: "já tinha feito isso antes com sucesso", vies: "Viés de Retrospectiva" } ] },
