...
const frases = [
  { id: 1, inicio: "O candle de reversão formou exatamente onde ele...", opcoes: [ { texto: "entrou", vies: "Viés de Confirmação" }, { texto: "estava torcendo", vies: "Otimismo Ilusório" }, { texto: "hesitou", vies: "Aversão à Perda" }, { texto: "pulou a entrada de ontem", vies: "Viés de Recência" } ] },
  ...
  { id: 7, inicio: "Ele moveu o estope contra porque...", opcoes: [ { texto: "usou o prejuizo anterior como base", vies: "Efeito de Ancoragem" }, { texto: "lembrou do último stop que bateu e voltou", vies: "Viés de Retrospectiva" }, { texto: "já estava muito perto e viu que ia bater" ]", vies: "Aversão à Perda" }, { texto: "achou que o mercado ia voltar e valia o risco", vies: "Excesso de Confiança" } ] },
  { id: 8, inicio: "Ele teve dúvida na hora entrar porque...", opcoes: [ { texto: "viu a galera do grupo falar que ia ficar de fora", vies: "FOMO" }, { texto: "errou as últimas entradas", vies: "Viés de Recência" }, { texto: "não queria errar de novo", vies: "Aversão à Perda" }, { texto: "achou que precisa de mais notícias", vies: "Viés de Confirmação" } ] },
  ...
  { id: 12, inicio: "Ele hesitou em vender com lucro porque...", opcoes: [ { texto: "falou que ia subir mais", vies: "FOMO" }, { texto: "não ia deixar dinheiro na mesa nessa tendência favorável "Aversão à Perda" }, { texto: "lembrou da última vez que vendeu cedo demais", vies: "Viés de Retrospectiva" }, { texto: "um amigo falou que ele estava certo", vies: "Viés de Confirmação" } ] },
  ...
  { id: 14, inicio: "Ele operou num horário que normalmente evita porque...", opcoes: [ { texto: "o pessoaltodo da sala operou", vies: "FOMO" }, { texto: "ontem neste mesmo horário deu muito bom e fiqeui de fora", vies: "Viés de Recência" }, { texto: "acreditava que o mercado ia repetir o padrão", vies: "Viés de Confirmação" }, { texto: "tinha feito isso na semana passada e funcionou", vies: "Viés de Retrospectiva" } ] },
  { id: 15, inicio: "Mesmo após bater a meta, ele continuou porque...", opcoes: [ { texto: "estava se sentindo que o dia era dele", vies: "Excesso de Confiança" }, { texto: "achava que ia conseguir dobrar a meta", vies: "Otimismo Ilusório" }, { texto: "leu no grupo que o mercado estava muito bom de operar", vies: "FOMO" }, { texto: "ainda ia sair um ", vies: "Viés de Confirmação" } ] },
  ...
  { id: 22, inicio: "Ele fechou a operação com lucro mínimo porque...", opcoes: [ { texto: "não queria perder", vies: "Aversão à Perda" }, { texto: "achava que o mercado ia virar", vies: "Viés de Confirmação" }, { texto: "o pessoal do sala saiu", vies: "FOMO" }, { texto: "já tinha passado por situação parecida antes", vies: "Viés de Retrospectiva" } ] },
